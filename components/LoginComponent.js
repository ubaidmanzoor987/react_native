        ...
        return (
            <View style={styles.container}>
                <Input
                    ...
                    leftIcon={{ type: 'font-awesome', name: 'user-o', iconStyle:{marginRight:15} }}
                ...
                <Input
                    ...
                    leftIcon={{ type: 'font-awesome', name: 'key', iconStyle:{marginRight:15} }}
    ...
    render() {
        return(
            ...
            <View style={styles.container}>
                ...
                <Input
                    placeholder="Email"
                    leftIcon={{ type: 'font-awesome', name: 'envelope-o', iconStyle:{marginRight:15} }}
